 ...
 * Copyright (c) 2009-2011 by match_the_words, Inc. All Rights Reserved.
...
//@interface match_the_wordsObject : NSObject
//@end

@interface match_the_wordsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[match_the_wordsObject class]])
		{
			for (NSString *key in [[(match_the_wordsObject*)o modules] allKeys])
			{
