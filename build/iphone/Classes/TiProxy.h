...
//Rare exceptions to indicate a bug in the _match_the_words code (Eg, function that a subclass should have implemented)
...
/**
 The base class for match_the_words proxies.
 */
