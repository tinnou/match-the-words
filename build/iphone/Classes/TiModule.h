...
/**
 The base class for all match_the_words modules
 */
...
/**
 match_the_words Platform calls this method on startup.
 */
-(void)startup;

/**
 match_the_words Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 match_the_words Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 match_the_words Platform calls this method on resume.
 @param sender The sender of the event.
 */
