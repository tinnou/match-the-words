...
@interface match_the_wordsObject : KrollCoverageObject {
#else
@interface match_the_wordsObject : KrollObject {
#endif
@private
...
extern NSString * match_the_words$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	match_the_wordsObject *_match_the_words;
	BOOL shutdown;
