...
// in simulator we redefine to format for match_the_words Developer console
...
{\
	NSString * exceptionName = [@"org.match_the_words." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.match_the_words";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UImatch_the_wordsNativeItemNone = -1, 
	UImatch_the_wordsNativeItemSpinner = -2,
	UImatch_the_wordsNativeItemProgressBar = -3,
	
	UImatch_the_wordsNativeItemSlider = -4,
	UImatch_the_wordsNativeItemSwitch = -5,
	UImatch_the_wordsNativeItemMultiButton = -6,
	UImatch_the_wordsNativeItemSegmented = -7,
	
	UImatch_the_wordsNativeItemTextView = -8,
	UImatch_the_wordsNativeItemTextField = -9,
	UImatch_the_wordsNativeItemSearchBar = -10,
	
	UImatch_the_wordsNativeItemPicker = -11,
	UImatch_the_wordsNativeItemDatePicker = -12,
	
	UImatch_the_wordsNativeItemInfoLight = -13,
	UImatch_the_wordsNativeItemInfoDark = -14,
	
	UImatch_the_wordsNativeItemDisclosure = -15,
	
	UImatch_the_wordsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all match_the_words instances of
